 ...
 * `PlantationCreationService.createPlantationWithDefaultParcela`). To disable:
 * flip to `false` and rebuild APK. No backfill of legacy plantations —
 * existing plantations stay as-is.
 */
