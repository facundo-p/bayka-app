...
describe('detalleDePendientes', () => {
  it('lista cada tipo pendiente, no solo los grupos', () => {
    expect(detalleDePendientes({ activaCount: 1, finalizadaCount: 2, parcelas: 1, fotos: 4, borrados: 2, especies: 3, tecnicos: 1 }))
      .toBe('3 grupos sin subir (1 activo, 2 finalizados), 1 parcela pendiente, 4 fotos sin subir, 2 borrados pendientes, 3 cambios de especies sin subir, 1 técnico asignado sin subir');
  });
