...
import { ES_ENTORNO_DE_PRUEBAS, VERSION_APP } from '../lib/entorno';
...
/** Franja fija "ENTORNO DE PRUEBAS · vX.Y.Z" (#287). Se monta una vez en App.tsx
 *  (cubre también /login). Es dueña de la franja Y del offset: marca el documento
 *  para que sidebar y Topbar se corran; en prod no renderiza ni marca nada. */
export function BannerEntornoPruebas() {
  ...
  return <div className={styles.banner}>{`ENTORNO DE PRUEBAS · ${VERSION_APP}`}</div>;
}
